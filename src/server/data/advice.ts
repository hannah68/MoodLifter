...
export const advices: Array<Advice> = [
	...
	},
	{
		text: [
			...
			"Have a growth mindset and set solid goals', 'Prepare yourself for setbacks but don't let them control you",
	...
	{
		text: [
			"Accept where you are. Accept the fog, accept the confusion and accept the feelings of “stuckness.” ",
			"Take a deep breath",
